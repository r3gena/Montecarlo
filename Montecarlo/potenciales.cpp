...
void lennard_jones(const int N, const float rc, const float rc2, const float L, const float V, double* E_p, double* dphi, double* d2phi, const double rx[], const double ry[], const double rz[], double ax[], double ay[], double az[])
{
	...
	*d2phi = 0;
	...
	//a�adimos las correcciones  y las operaciones finales para el calculo de las derivadas de phi
	*E_p = *E_p * 4 + ep_corr;
...
//definimos la funci�n de lennard jones para montecarlo
...
//lennardo jones para una sola particula
